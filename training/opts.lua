...
function M.parse(arg)
   ...
   cmd:option('-negOnlyFromSameImage', true, 'Negative samples retrived from segments only from the same image')
   cmd:option('-saveInterval', 1, 'Save model every x epcohs')
   ...
   cmd:option('-testEpochSize', 3, 'Number of batches per epoch')
